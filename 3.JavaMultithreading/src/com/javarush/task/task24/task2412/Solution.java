...
public class Solution {
        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (res == 0) {
                    ...
                    if(res == 0) {
                        if(!stock1.containsKey("open")) return res;
                        double prib1 = (double) stock1.get("last") - (double) stock1.get("open");
                        double prib2 = (double) stock2.get("last") - (double) stock2.get("open");
                        res = Double.compare(prib2, prib1);
                    }
                }
                return res;
            }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Microsoft Corporation", "MSFT", 29.0, 30.0));
        stocks.add(new Stock("Fake Microsoft Corporation", "MSFT", 29.0, 31.72));
